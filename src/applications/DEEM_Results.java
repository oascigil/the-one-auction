...
public class DEEM_Results{
    ...
    public DEEM_Results(int numberOfIterations,HashMap<DTNHost,DTNHost> userDeviceAssociation,HashMap<DTNHost,Integer> deviceLLAExecution,HashMap<DTNHost,Double> p,HashMap<DTNHost,Double> QoSGainPerUser,HashMap<DTNHost,Double> QoSPerUser) {
